...
function generateMiddleware(options = {}) {
  ...
  let isSuccess = typeof options.isSuccess === 'function' ? options.isSuccess : () => {};
  let success = typeof options.success === 'function' ? options.success : () => {};
  let failure = typeof options.failure === 'function' ? options.failure : () => {};
